...
public class SearchUpdateListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_news_search, parent, false);
		vh = new ViewHolder(v);
		return vh;
	}
	...
	public SearchUpdateListAdapter(Context context, List<Kriminal> items){
		this.items = items;
		ctx = context;
	}
	...
	public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
		if (holder instanceof SearchUpdateListAdapter.ViewHolder) {
			SearchUpdateListAdapter.ViewHolder view = (SearchUpdateListAdapter.ViewHolder) holder;
