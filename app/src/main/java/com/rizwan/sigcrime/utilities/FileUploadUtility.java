...
public class FileUploadUtility {
	static String SERVER_PATH = "http://192.168.1.5/sig/uploaderprofile.php";

	public static void doFileUpload(final String selectedPath, final Handler handler) {
		Log.d("Upload Class", "doFileUpload: " + selectedPath);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Log.d("Upload Class", "run: " + fileInputStream.toString());
					...
					dos.writeBytes("Content-Disposition: form-data; name=uploadedfile1;"
	...
	static void sendMessageBack(String responseFromServer, int success, Handler handler) {
		...
		Log.i("upload class", "sendMessageBack: " + message.obj.toString());
